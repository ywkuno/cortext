...
- `scripts/render_benchmark_chart.py ... --check` fails CI or release proof when the checked-in SVG chart is stale.
...
- `CONTRIBUTING.md` and `SECURITY.md` cover public contribution, privacy, and vulnerability-reporting expectations.
